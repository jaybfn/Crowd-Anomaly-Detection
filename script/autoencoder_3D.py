...
class AutoEncoder3D():
    ...
    def autoencoder(self):
        ...
        model.add(Conv3D(filters= self.FILTER,kernel_size=(11,11,1),strides=(2,2,1),padding='valid',input_shape=(self.SIZE,self.SIZE,1,1),activation=self.ACTIVATION))
        ...
        model.add(ConvLSTM2D(filters= round(self.FILTER/2),kernel_size=(3,3),strides=1,return_sequences=True, padding='same',dropout=0.1))
        # spatial decoder
