...
class AutoEncoder3D():
    ...
    def autoencoder(self):
        ...
        model.add(Conv3D(filters= round(self.FILTER),kernel_size=(11,11,1),strides=(2,2,1),padding='valid',input_shape=(self.SIZE,self.SIZE,1, 1),activation=self.ACTIVATION))
